	...
	{else}
		...
		<div id="schedule" class="recurring-dates-container">
			...
			<div class="calendar-toggle">
				<h2 class="title">{__ ('Scheduled Dates')} <span class="calendar-count">{$datesCount}</span></h2>
			</div>
			...
			<script>
				...
				function eventsCarousel() {
					var container = jQuery("#schedule"),
						...
						carouselWidth = jQuery("#schedule .dates-wrap").parent().width(),
						carouselArrows = jQuery("#schedule .carousel-arrows"),
						oneBoxWidth = jQuery("#schedule .dates-carousel .single-date").outerWidth(),
