...
class Test_ItemImport_Object extends WP_UnitTestCase {
	...
	public function test_import_ItemImport_Object_can_set_replace_inline_assets() {
		$data = array(
			...
			'data' => array(
				'post_title' => 'Object Title',
				'post_content' => '<img src="http://f6ca679df901af69ace6-d3d26a34307edc4f7eeb40d85a64c4a7.r91.cf5.rackcdn.com/marketify-xml-images/company-logo.png" alt="Test Case" />',
			),
		);
