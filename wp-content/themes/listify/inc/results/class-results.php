...
class Listify_Results {
	...
	public static function register_scripts() {
		...
		// Leaflet.
		wp_register_script( 'leaflet', '//api.mapbox.com/mapbox.js/v3.3.1/mapbox.js', array(), '3.3.1', true );
		wp_register_style( 'leaflet', '//api.mapbox.com/mapbox.js/v3.3.1/mapbox.css', array(), '3.3.1' );
