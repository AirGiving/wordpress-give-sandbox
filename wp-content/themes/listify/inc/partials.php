...
if ( ! function_exists( 'listify_partial_site_branding' ) ) {
	...
	<a href="<?php echo esc_url( home_url( '/' ) ); ?>" aria-title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home" class="custom-header">
		<img src="<?php echo esc_url_raw( $base_header_image ); ?>" aria-hidden="true" role="presentation" class="custom-header-image" />

			<?php if ( $base_header_image !== $header_image ) : ?>
			<img src="<?php echo esc_url_raw( $header_image ); ?>" aria-hidden="true" role="presentation" class="custom-header-image--transparent" />
		<?php endif; ?>
	</a>
		<?php endif; ?>
