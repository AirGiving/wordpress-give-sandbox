...
Tags: group chat, chat, chatroom, members chat, online event, buddypress chat, chat room, paywall, community chat, bbpress chat, forex chat, radio chat, embed chat, chat platform, ultimate member, chat members, video chat, social chat, discussion chat, team chat, html5 chat, chatroom widget, chat plugin, live chat, chat widget, chat box, chatbox, popup chat, mobile chat
...
662,800 websites and live events are already using the <a href="https://www.rumbletalk.com/">RumbleTalk HTML Chat Platform</a>.
...
Adding one or many room is no brainer with RumbleTalk plugin. Add a chat widget to the your website in two minutes.
...
5. This step is only in case you already have an account with RumbleTalk - Login to the RumbleTalk admin panel https://www.rumbletalk.com
...
8. If you want to allow autologin for your registered users, click on the integration checkbox, SAVE and your done. 
...
== Screenshots ==
1. The most advanced chat room for groups with over then 630,000 installations, upload files, images and docs.
2. Change your chat theme and customize it to your own liking.
3. Mobile chat (tablets & smart-phones). A chat to go, keep talking from anywhere.
4. Private chat - talk in private with people in the chat.
5. Live video call - talk to anyone with a live one on one call
6. Paywall - you can set the chat to allow entrance only after payment.
7. Send payment request while being in a private chat.
8. Set your chat to collect donations.
9. Change your design using CSS, see in here a font size change via css.
10. Choose to add the chat as a floating chat.
11. Add image to the conversation
...
- added avatar integration so when members logs in we take the users images from wordpress.
...
20.11.2019
– New chat dialog
– Mark text as a bold, italic, strike and code. https://www.rumbletalk.com/blog/index.php/2019/07/08/text-formatting/
– Admin mode – mute all users. https://www.rumbletalk.com/blog/index.php/2019/09/16/mute-button/
– New lines – now you can add more lines in each message
– Font size – increase/decrease the web-based font size
– Private chat – prevents automatic private chat window popup.
...
12.9.2019
- added the [shortcode] for admin button: [rumbletalk-admin-button]; this button links to the chat when their is an admin available
...
- supports the 'text' - the text to display in cases where the are admins available
...
We just added support for avtars integration with several members plugins systems .

Avatar integration for members.
Now, when members logs-in we take show his wordpress avatar in the chat.
