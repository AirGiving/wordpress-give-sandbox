    ...
    <div id="manage-chats-page" class="rt-page">
        <div class="header">
            ...
            <div class="managing-buttons">
                ...
                <button type="button" class="button-main" id="admin-panel">Administration Panel</button>
                <button type="button" class="button-main" id="manage-keywords">Manage Keywords</button>
            </div>
        </div>
