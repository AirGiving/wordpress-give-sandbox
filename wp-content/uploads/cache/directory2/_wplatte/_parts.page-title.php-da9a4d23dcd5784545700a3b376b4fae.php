<?php //netteCache[01]000594a:2:{s:4:"time";s:21:"0.62519900 1608561953";s:9:"callbacks";a:4:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:105:"/home/customer/www/evernewjia.com/public_html/airgiving/wp-content/themes/directory2/parts/page-title.php";i:2;i:1607214400;}i:1;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:20:"NFramework::REVISION";i:2;s:22:"released on 2014-08-28";}i:2;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:15:"WPLATTE_VERSION";i:2;s:5:"2.9.2";}i:3;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:17:"AIT_THEME_VERSION";i:2;s:6:"4.0.19";}}}?><?php

// source file: /home/customer/www/evernewjia.com/public_html/airgiving/wp-content/themes/directory2/parts/page-title.php

?><?php
// prolog NCoreMacros
list($_l, $_g) = NCoreMacros::initRuntime($template, 'mjlxkrhyp2')
;
// prolog NUIMacros
...
<?php $titleClass = '' ;$titleName = '' ;$editButton = '' ;$titleImage = '' ;$dateIcon = '' ;$dateLinks = '' ;$dateShort = '' ;$dateInterval = '' ;$titleAuthor = '' ;$titleCategory = '' ;$titleComments = '' ;$titleSubDesc = '' ;$titleDesc = $el->option('description') ;$pageShare = $el->option('pageShare') && !$wp->isSearch ;$showPager = '' ;$titleExcerpt = '' ;$categoryColor = '' ?>
...
<?php $eventProMeta = $post->meta('event-pro-data') ;ob_start() ;NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("portal/parts/single-event-date", ""), array('meta' => $eventProMeta, 'place' => 'header', 'eventId' => $post->id) + get_defined_vars(), $_l->templates['mjlxkrhyp2'])->render() ;$eventDateIcon = ob_get_clean() ;} ?>

<?php if ($wp->isSingular('job-offer')) { if ($post->imageUrl('thumbnail')) { $categoryIcon = $post->imageUrl('thumbnail') ;} } ?>
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/entry-date-format", ""), array('dateIcon' => $dateIcon, 'dateLinks' => $dateLinks, 'dateShort' => $dateShort) + get_defined_vars(), $_l->templates['mjlxkrhyp2'])->render() ;if (isset($eventDateIcon)) { ?>
						<?php echo $eventDateIcon ?>

<?php } ?>
				<div class="entry-title-wrap">

<?php if (isset($category) and isset($categoryIcon)) { ?>
...
" alt="<?php echo $category->name ?>" /></span></div>
...
<?php } ?>
							...
							<?php if ($titleAuthor == 'yes') { ?> 		<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/entry-author", ""), array() + get_defined_vars(), $_l->templates['mjlxkrhyp2'])->render() ?>
		<?php } ?>

							<?php if ($titleCategory == 'yes') { ?>	<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/entry-categories", ""), array() + get_defined_vars(), $_l->templates['mjlxkrhyp2'])->render() ?>
	<?php } ?>

							<?php if ($titleComments == 'yes') { ?>	<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/comments-link", ""), array() + get_defined_vars(), $_l->templates['mjlxkrhyp2'])->render() ?>
		<?php } ?>
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/breadcrumbs", ""), array() + get_defined_vars(), $_l->templates['mjlxkrhyp2'])->render() ?>
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/pagination", ""), array('arrow' => 'left') + get_defined_vars(), $_l->templates['mjlxkrhyp2'])->render() ;NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/pagination", ""), array('arrow' => 'right') + get_defined_vars(), $_l->templates['mjlxkrhyp2'])->render() ?>
			</nav>
<?php } ?>
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/page-share", ""), array('showShare' => $pageShare) + get_defined_vars(), $_l->templates['mjlxkrhyp2'])->render() ?>
		<!-- page title social icons -->
