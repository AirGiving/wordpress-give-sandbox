<?php //netteCache[01]000584a:2:{s:4:"time";s:21:"0.48666600 1608561953";s:9:"callbacks";a:4:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:96:"/home/customer/www/evernewjia.com/public_html/airgiving/wp-content/themes/directory2/@layout.php";i:2;i:1607214400;}i:1;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:20:"NFramework::REVISION";i:2;s:22:"released on 2014-08-28";}i:2;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:15:"WPLATTE_VERSION";i:2;s:5:"2.9.2";}i:3;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:17:"AIT_THEME_VERSION";i:2;s:6:"4.0.19";}}}?><?php

// source file: /home/customer/www/evernewjia.com/public_html/airgiving/wp-content/themes/directory2/@layout.php

?><?php
// prolog NCoreMacros
list($_l, $_g) = NCoreMacros::initRuntime($template, '9lrpsyjh0b')
;
// prolog NUIMacros
...
<?php $searchFormType = $elements->unsortable['search-form']->display ? $elements->unsortable['search-form']->options['type'] : '' ?>
...
<?php $toggleButtonGroup = false ;$togglableSearch = true ?>

<?php if ($wp->isTax('items') or $wp->isTax('locations') or $wp->isSingular('item') or $wp->isTax('ait-events-pro') or $wp->isSingular('ait-event-pro') or $wp->isSearch) { if ($headerLayoutType == 'map') { $toggleButtonGroup = true ;} } ?>

<?php if ($layoutType != 'full' and $searchFormType != 3) { $toggleButtonGroup = true ;} ?>

<?php if (!$elements->unsortable['search-form']->display) { $togglableSearch = false ;} ?>
...
<?php if ($toggleButtonGroup) { ?>
	<div class="ait-toggle-area-group-container toggle-group-map-search-container <?php if ($headerLayoutType != 'map') { ?>
no-toggle-map<?php } if (!$togglableSearch) { ?> no-toggle-search<?php } ?>">
		<div class="grid-main">
			<div class="ait-toggle-area-group toggle-group-map-search">
<?php if ($headerLayoutType == 'map') { ?>
...
<?php } if ($elements->unsortable['search-form']->display) { ?>
					<a id="toggle-search-top" href="#" class="ait-toggle-area-btn" data-toggle=".elm-search-form"><i class="fa fa-search"></i> <?php echo NTemplateHelpers::escapeHtml(__('Search', 'wplatte'), ENT_NOQUOTES) ?></a>
<?php } ?>
			</div>
		</div>
	</div>
...
<?php if ($headerLayoutType == 'revslider') { if ($elements->unsortable['revolution-slider']->display) { if($elements->unsortable['revolution-slider']->getId() === 'columns' or $elements->unsortable['revolution-slider']->isEnabled()){
				NCoreMacros::includeTemplate($elements->unsortable['revolution-slider']->getTemplate(), array('el' => $elements->unsortable['revolution-slider'], 'element' => $elements->unsortable['revolution-slider'], 'htmlId' => $elements->unsortable['revolution-slider']->getHtmlId(), 'htmlClass' => $elements->unsortable['revolution-slider']->getHtmlClass()) + $template->getParameters(), $_l->templates['9lrpsyjh0b'])->render();
			}else{
				...
				NCoreMacros::includeTemplate($elements->unsortable['header-map']->getTemplate(), array('el' => $elements->unsortable['header-map'], 'element' => $elements->unsortable['header-map'], 'htmlId' => $elements->unsortable['header-map']->getHtmlId(), 'htmlClass' => $elements->unsortable['header-map']->getHtmlClass()) + $template->getParameters(), $_l->templates['9lrpsyjh0b'])->render();
			}else{
				...
				NCoreMacros::includeTemplate($elements->unsortable['header-video']->getTemplate(), array('el' => $elements->unsortable['header-video'], 'element' => $elements->unsortable['header-video'], 'htmlId' => $elements->unsortable['header-video']->getHtmlId(), 'htmlClass' => $elements->unsortable['header-video']->getHtmlClass()) + $template->getParameters(), $_l->templates['9lrpsyjh0b'])->render();
			}else{
...
<?php if ($elements->unsortable['search-form']->display) { if($elements->unsortable['search-form']->getId() === 'columns' or $elements->unsortable['search-form']->isEnabled()){
				NCoreMacros::includeTemplate($elements->unsortable['search-form']->getTemplate(), array('el' => $elements->unsortable['search-form'], 'element' => $elements->unsortable['search-form'], 'htmlId' => $elements->unsortable['search-form']->getHtmlId(), 'htmlClass' => $elements->unsortable['search-form']->getHtmlClass()) + $template->getParameters(), $_l->templates['9lrpsyjh0b'])->render();
			}else{
...
<?php if ($wp->isTax('items') or $wp->isTax('locations') or $wp->isTax('ait-events-pro')) { NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("portal/parts/taxonomy-category-list", ""), array('taxonomy' => $currentCategory->taxonomy, 'gridMain' => true) + get_defined_vars(), $_l->templates['9lrpsyjh0b'])->render() ;} elseif ($wp->isPostTypeArchive('ait-item')) { NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("portal/parts/taxonomy-category-list", ""), array('taxonomy' => 'ait-items', 'gridMain' => true) + get_defined_vars(), $_l->templates['9lrpsyjh0b'])->render() ;} elseif ($wp->isPostTypeArchive('ait-event-pro')) { NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("portal/parts/taxonomy-category-list", ""), array('taxonomy' => 'ait-events-pro', 'gridMain' => true) + get_defined_vars(), $_l->templates['9lrpsyjh0b'])->render() ;} ?>
...
<?php if($element->getId() === 'columns' or $element->isEnabled()){
				NCoreMacros::includeTemplate($element->getTemplate(), array('el' => $element, 'element' => $element, 'htmlId' => $element->getHtmlId(), 'htmlClass' => $element->getHtmlClass()) + $template->getParameters(), $_l->templates['9lrpsyjh0b'])->render();
			}else{
